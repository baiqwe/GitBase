    ...
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto space-y-7 px-4 py-8 md:px-6 md:py-10">
        ...
        <section className="space-y-4">
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <h1 className="max-w-4xl font-serif text-2xl leading-[0.95] tracking-tight text-slate-950 md:text-4xl lg:text-[2.8rem]">
                {title}
              </h1>
              {!isHome ? (
        ...
        <VisualGenerator
          ...
          defaultCount={defaultVisualCount}
          title={visualTitle}
          description={visualDescription}
        />
        <BulkGenerator locale={locale} items={items} heading={bulkTitle} helperText={bulkDescription} />
      </div>
